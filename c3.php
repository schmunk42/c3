...
if (!defined('C3_CODECEPTION_CONFIG_PATH')) {
    ...
    $config_dist_file = C3_CODECEPTION_CONFIG_PATH . DIRECTORY_SEPARATOR . 'codeception.dist.yml';
    $config_file = C3_CODECEPTION_CONFIG_PATH . DIRECTORY_SEPARATOR . 'codeception.yml';
}
